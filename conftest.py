...
@pytest.fixture(scope="function")
def shorter(deployer, mockBTC, mockUSDT, swapper, vegalabs):
    shorter = Shorter.deploy(swapper, vegalabs, mockUSDT, mockBTC, {"from": deployer})
    mockUSDT.transfer(shorter, 10_000e6, {"from": deployer})
    yield shorter